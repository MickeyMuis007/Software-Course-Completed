...
public class SupportCommandController {
	...
	@PutMapping("/support")
	public void createNewQuery(@RequestBody CreateSupportQueryRequest createSupportQueryRequest, @AuthenticationPrincipal JwtAuthenticationToken principal) {
		createSupportQueryRequest.setUsername(principal.getToken().getClaimAsString("preferred_username"));
